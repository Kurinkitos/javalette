  ...
  b ">" 23
    (b "-" 12
       (b ")" 6
          ...
          (b "+" 9
             (b "*" 8 (b ")null" 7 N N) N) (b "," 11 (b "++" 10 N N) N)))
       (b ";" 18
          (b "." 15
    ...
    (b "int" 34
       (b "double" 29
          (b "[]" 26
             (b "[" 25 (b ">=" 24 N N) N) (b "boolean" 28 (b "]" 27 N N) N))
          (b "for" 32 (b "false" 31 (b "else" 30 N N) N) (b "if" 33 N N)))
       (b "void" 40
          (b "struct" 37
             (b "return" 36 (b "new" 35 N N) N)
             (b "typedef" 39 (b "true" 38 N N) N))
